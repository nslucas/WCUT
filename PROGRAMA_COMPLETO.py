...
arquivo = open("plano de corte " + nome_cliente, "a")
...
if porta =='sim':
 ...
 if numero_portas < 1:
    pass
 if numero_portas == 1:
     one_door_no_handle = math.floor('1x {}*{}*{} (4L) porta\n'.format(porta_sem_puxador,porta_largura,espessura,))
     print(one_door_no_handle)
 if numero_portas == 2:
    two_door_no_handle = ('2x {}*{}*{} (4L) porta\n'.format(porta_sem_puxador,porta_largura_two/2,espessura,))
    print(two_door_no_handle)
    arquivo.write(one_door_no_handle + two_door_no_handle)
...
if quantidade_gavetas == 1:
    ...
    arquivo.write(one_drawer + lat_one_drawer + back_one_drawer + lat_one_drawer + back_one_drawer)
