...
while True:
    ...
    if ambiente == 'cozinha':
        ...
        if lugar == 'inferior':
            ...
            if perguntaTipo == 'gaveteiro':
                rodapegav = str(input('É gaveteiro com rodapé? '))
                if rodapegav == 'sim':
            ...
            if perguntaTipo == 'porta-tempeiro':
                altura = int(input('Qual é a altura? '))
                largura = int(input('Qual é a largura? '))
                subtracao_largura = largura - 30
                largura_aux = largura - 10
    ...
    if ambiente == 'quarto':
            ...
            porta_roupeiro = str(input('É porta de correr? '))
            ...
            largura_porta_correr = math.floor(largura_aux/2) + 18
            altura_porta = alt_roupeiro - vista_roupeiro - 80 - 30
            porta_largura_roupeiro = largura_roupeiro - 10
            porta_largura2 = math.floor(porta_largura_roupeiro/2)
            ...
            if porta_roupeiro == 'sim':
                print_porta_correr = '2x {}*{}*{} (4L) porta roupeiro'.format(altura_porta, largura_porta_correr - 70,espessura )
                print(print_porta_correr)
            else:
                qnt_portas = str(input('Quantas portas? '))
                if qnt_portas == '1':
                    print_porta_normal = '1x {}*{}*{} (4L) porta roupeiro'.format(altura_porta, largura_roupeiro - 10, espessura)
                    print(print_porta_normal)
                if qnt_portas == '2':
                    print_duasportas_normal = '2x {}*{}*{} (4L) porta roupeiro'.format(altura_porta, porta_largura2, espessura)
                    print(print_duasportas_normal)
